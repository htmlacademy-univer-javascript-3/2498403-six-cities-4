        ...
        <div className="near-places__list places__list">
          <article className="near-places__card place-card">
            <div className="near-places__image-wrapper place-card__image-wrapper">
              <a href="src/components/nearPlaces/NearPlaces#">
            ...
            <div className="place-card__info">
              ...
              <h2 className="place-card__name">
                <a href="src/components/nearPlaces/NearPlaces#">Wood and stone place</a>
              </h2>
          ...
          <article className="near-places__card place-card">
            ...
            <div className="place-card__info">
              ...
              <h2 className="place-card__name">
                <a href="src/components/nearPlaces/NearPlaces#">Canal View Prinsengracht</a>
              </h2>
          ...
          <article className="near-places__card place-card">
            ...
            <div className="place-card__info">
              ...
              <h2 className="place-card__name">
                <a href="src/components/nearPlaces/NearPlaces#">Nice, cozy, warm big bed apartment</a>
              </h2>
              <p className="place-card__type">Apartment</p>
            </div>
          </article>
